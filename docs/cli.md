...
| `-z` | `--compress` | off | negotiates zstd, lz4, zlibx, or zlib | [matrix](feature_matrix.md#--compress) |
|  | `--compress-choice` | auto | supports zstd, lz4, zlibx, and zlib | [matrix](feature_matrix.md#--compress-choice) |
